...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 15 20:54:42 2018

@author: samiksadhu
"""


'Computing FDLP Time-Frequency Patterns'
...
def extractFDLPTfPattern(wavs, outdir, phone_map, phn_file_dir, get_phone_labels=False, only_center=False, ignore_edge=False, order=50, fduration=0.5, frate=100,
                            nfft=20, nfilters=15, srate=16000,
                            window=np.hanning):
...
if __name__ == '__main__':
    ...
    parser.add_argument('nfft', type=int, default=20,help='Samples in frequency response of LPC filter')
    ...
    extractFDLPTfPattern(args.scp, args.outdir, args.phn_file, args.phn_file_dir, args.get_phone_labels,args.only_center,args.ignore_edge,args.order,args.fduration,args.frate,args.nfft,args.nfilters)
