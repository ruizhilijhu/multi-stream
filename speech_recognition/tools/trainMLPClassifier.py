...
def tidyData(data_dir):
    ...
    print('Checking for train and test data...')
    allfiles = [f for f in listdir(data_dir) if isfile(join(data_dir, f))]
    print('In total %d train and test data files found..' % len(allfiles))
    ...
    print('Load all train and test data into one file...')
